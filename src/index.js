...
module.exports = {
  config: {
    ...
    qnaMinimumConfidence: { type: 'string', required: false, default: '0', env: 'QNA_MAKER_MINIMUM_CONFIDENCE' },
    qnaLowConfidenceAnswers: { type: 'string', required: false, default: 'No answer found', env: 'QNA_MAKER_LOW_CONFIDENCE_ANSWERS' },
  },
